...
```text
Voxelum/xmcl-shared-minecraft-compiler
```
...
`xmcl-shared-minecraft-runtime` lock and bound to every toolchain catalog
revision.
...
.github/workflows/update-toolchain-catalog.yml
```
